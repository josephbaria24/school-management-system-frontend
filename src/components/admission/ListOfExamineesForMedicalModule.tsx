...
export function ListOfExamineesForMedicalModule() {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      try {
        ...
        // keep selectors usable even when fetch fails
      }
    };
    void load();
  }, []);
      ...
      <div className="w-full px-2 pt-2 pb-4">
        <div className="mb-5 flex items-start justify-between gap-4">
          <div className="space-y-1">
            <h1 className="setup-type-page-title">List of Examinees for Medical</h1>
            <p className="setup-type-page-desc">
              View the medical examinees list by selected campus and academic year/term.
            </p>
          </div>
        ...
        <div className="overflow-hidden rounded-2xl bg-background border border-border/40 shadow-sm">
          <div className="px-4 py-3 flex items-center gap-3 border-b border-border/40 bg-muted/5">
            <div className="leading-tight min-w-0">
              <div className="setup-type-module-title truncate">Medical Examinees Workspace</div>
              <div className="setup-type-module-sub">Review medical queue and status details</div>
            </div>
          </div>
